...
export default function AdminDashboard() {
  return (
    ...
    <div className='col-md-3 ms-0 bg-warning p-4 mt-0'>
    <span className="bi bi-facebook fs-4 text-center text-white">  Facebook</span>
    </div>
    <div className='col-md-3 ms-5 bg-secondary p-4 mt-0'>
     <span className="bi bi-twitter fs-4 text-center text-white">  Twitter</span>
     </div>
    <div className='col-md-3 ms-5 bg-success p-4 mt-0'>
    <span className="bi bi-google fs-4 text-center text-white">  google</span>
    </div> 
   </Row>
   </Container>
