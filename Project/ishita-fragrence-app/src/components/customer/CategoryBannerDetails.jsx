...
<p className='text-3xl ms-5'> Name:<input type='text' ref={ productname} style={{color:"black",width:"100%"}} readOnly /></p>

<p className='text-2xl ms-5'>Description: <input type='text' ref={description} style={{fontSize:"17px",width:"100%"}} /></p>
<p className='text-2xl ms-5'>Old Price:<input type='text' ref={oldprice} style={{fontSize:"17px",width:"100%"}} /></p>

<p className='text-2xl ms-5'>New Price:<input type='text' ref={newprice} style={{fontSize:"17px",width:"100%"}} /></p>
<p className='text-2xl ms-5'>Quantity: <input type='text' ref={quantity} style={{fontSize:"17px",width:"100%"}} /></p>
</div>
</div>
</div>
<Footer />
