...
return(
    ...
    <h1> <span className="gray"  >First Rain Attar</span></h1>
...
<div> 
    <p>
        'First rain Attar' is a lavish masculine perfume which is warm and embracing. With the power of Patchouli and Lavender, it draws the wearer into a sense of piquant enchantment. Adding a hint to your sensuality; Above & Beyond is royal with a definite modern edge.
    </p>
...
<label className='box-shadow'><sup>9 (ml)</sup></label>
  <br/>
<p className='price-set'>RS.3600</p>
</div>
<div className='pros'>
