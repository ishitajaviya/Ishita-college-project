      ...
      <section className="section">
        ...
        <div className="founder-details">
          ...
          <div className="founder-description">
            <p>
              The Founder & CEO of ISAK Fragrances - Vidushi Vijayvergiya’s voyage as a perfumer & serial entrepreneur to understand the new world as well as extensive interest and research in aroma customization started from Switzerland, France, and India.
            </p>
            <p>
              "Having grown up around fragrances I have always been drawn to them and as I ventured towards exploring it more, I came to realize that Indian perfumery has its own unique charm. There are a lot of people who appreciate it but know little about the art. Thus, through ISAK my intention is to talk more about our roots, heritage and the charm in Indian perfumery and introduce it to the rest of the world to be mesmerized with." - Vidushi Vijayvergiya.
            </p>
          </div>
        </div>
      </section>
